"""
WavLM Audio Embedding Utilities
A module for extracting embeddings from audio using Microsoft WavLM.

WavLM is a self-supervised speech model that captures speaker-related artifacts
well, achieving 0.65% EER on ASVspoof deepfake detection benchmarks.

References:
    - Model: https://huggingface.co/microsoft/wavlm-base-plus
...
class AudioEmbeddingExtractor:
    """
    A class for extracting embeddings from audio using Microsoft WavLM.

    WavLM uses self-supervised learning on speech data, making it particularly
    good at capturing speaker-related artifacts that are useful for deepfake detection.
    """
    ...
    def extract_from_audio_data(
        ...
        # WavLM processor expects list of arrays
